...
public class BudgetCategoryImpl extends SourceImpl implements BudgetCategory {
	...
	public Map<String, Long> getAmountOfBudgetPeriods() {
		if (amounts == null)
	...
	public long getAmountOfBudgetPeriod(Date periodDate){
		Long l = getAmountOfBudgetPeriods().get(getPeriodKey(periodDate));
		if (l == null)
			return 0;
		return l;
	}
	...
	public void setAmount(Date periodDate, long amount){
		if (getAmountOfBudgetPeriod(periodDate) != amount)
			setChanged();
		getAmountOfBudgetPeriods().put(getPeriodKey(periodDate), amount);
	}
...
//		}
	...
	public List<Date> getBudgetedDates() {
		...
		Map<String, Long> amounts = getAmountOfBudgetPeriods();
